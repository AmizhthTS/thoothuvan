...
public interface MapKeys {
	...
	public static String VMN="vmn";
	public static String KEYWORD="keyword";
	public static String MT_ACKID="mt_ackid";
	...
	public static String UDH_ACKID="udh_ackid";
	...
	public static String SPLIT_MSGID="splitmsgid";
	...
	public static String REDISROUTEGROUP = "redisroutegroup";

	public static String REDISID = "redisid";
	...
	public static String FROM_ADDRESS="fromaddress";

	public static String SUBJECT="subject";
	
	public static String REQUEST_TYPE="requesttype";

	public static String ATTCHEMENT_COUNT="attchementcount";

	public static String EMAIL_TEMPLATE_ID="emailtemplateid";

	public static String EMAIL_ATTACHEMENT="emailattachement";
